...
@register_task("robowits/28_05-v0")
class MoveCubeMut5Env(MoveCubeEnv):
    @property
    def placement_groups(self) -> PlacementGroups | None:
        """Define placement groups for random initialization."""
        return ("cube 1", "cube 2", "cube 3", "goal line", "smooth ramp")
    ...
    def _add_custom_entities(self) -> None:
        ...
        _e = self._scene.scene.add_entity(
            gs.morphs.Box(
                pos=(0.45, -0.05, 0.78), euler=(0, 0, 0), size=(0.04, 0.04, 0.04), fixed=False, collision=True
            ),
        ...
        _e = self._scene.scene.add_entity(
            gs.morphs.Box(
                pos=(0.45, 0.00, 0.78), euler=(0, 0, 0), size=(0.04, 0.04, 0.04), fixed=False, collision=True
            ),
            material=gs.materials.Rigid(rho=200.0, friction=0.01),
        ...
        _e = self._scene.scene.add_entity(
            gs.morphs.Box(
                pos=(0.90, 0.00, 0.7605), euler=(0, 0, 0), size=(0.005, 0.70, 0.001), fixed=True, collision=False
            ),
