...
@register_task("robowits/05_04-v0")
class RollUpBallMut4Env(RollUpBallEnv):
    @property
    def placement_groups(self) -> PlacementGroups | None:
        """Define placement groups for random initialization."""
        return ("box", "high basket", "long board", "slope")
    ...
    def _add_custom_entities(self) -> None:
        ...
        _e = self._scene.scene.add_entity(
            gs.morphs.Mesh(
                ...
                scale=0.1411,
                pos=(0.49, 0.4, 0.76 + 0.0468 * 0.1411),
                euler=(0, 0, 0),
                fixed=True,
                collision=True,
            ),
        ...
        _e = self._scene.scene.add_entity(
            gs.morphs.Box(
                pos=(0.3, -0.12, 0.76 + 0.05), euler=(0, 0, 0), size=(0.1, 0.1, 0.1), fixed=False, collision=True
            ),
