...
@register_task("robowits/12_02-v0")
class BallIntoBottleMut2Env(BallIntoBottleEnv):
    @property
    ...
    def _add_custom_entities(self) -> None:
        ...
        _e = self._scene.scene.add_entity(
            gs.morphs.Mesh(
                ...
                scale=0.85,
                pos=(0.52, 0.00, 0.76 + 0.1422 * 0.85),
                euler=(0, 0, 0),
                fixed=False,
                collision=True,
            ),
        ...
        _e = self._scene.scene.add_entity(
            gs.morphs.Mesh(
                ...
                scale=0.35,
                pos=(0.34, 0.12, 0.76 + 0.1086 * 0.35),
                euler=(0, 0, 0),
                fixed=False,
                collision=True,
            ),
        ...
        _e = self._scene.scene.add_entity(
            gs.morphs.Mesh(
                ...
                scale=0.90,
                pos=(0.70, 0.30, 0.76 + 0.0893 * 0.90),
                euler=(0, 0, 0),
                fixed=False,
                collision=True,
            ),
        ...
        _e = self._scene.scene.add_entity(
            gs.morphs.Mesh(
                ...
                scale=0.48,
                pos=(0.66, 0.25, 0.76 + 0.0529 * 0.48),
                euler=(0, 0, 0),
                fixed=False,
                collision=True,
            ),
