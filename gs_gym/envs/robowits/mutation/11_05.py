...
@register_task("robowits/11_05-v0")
class PlaceTallBoxMut5Env(PlaceTallBoxEnv):
    @property
    ...
    def _add_custom_entities(self) -> None:
        ...
        _e = self._scene.scene.add_entity(
            gs.morphs.Cylinder(
                pos=(0.50, 0.00, 0.76 + 0.02), euler=(90, 0, 0), radius=0.02, height=0.16, fixed=False, collision=True
            ),
            material=gs.materials.Rigid(rho=700.0, friction=0.6),
            surface=gs.surfaces.Smooth(color=(0.72, 0.55, 0.35), double_sided=False),
        )
