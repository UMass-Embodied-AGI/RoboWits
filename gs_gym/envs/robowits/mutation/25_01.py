...
@register_task("robowits/25_01-v0")
class WaterIntoMugMut1Env(WaterIntoMugEnv):
    @property
    def placement_groups(self) -> PlacementGroups | None:
        """Define placement groups for random initialization."""
        return (("pitcher", "water", "mug"), "heavy_large_object", "coffee mug", "stapler", "chasen", "ladle")
    ...
    def _add_custom_entities(self) -> None:
        ...
        _e = self._scene.scene.add_entity(
            gs.morphs.Mesh(
                ...
                scale=0.7,
                pos=(0.72, 0.25, 0.76 + 0.0347),
                euler=(0.0, 0.0, -20.0),
                fixed=False,
                collision=True,
            ),
            material=gs.materials.Rigid(rho=7800.0, friction=0.8),
            surface=gs.surfaces.Rough(double_sided=True),
        )
