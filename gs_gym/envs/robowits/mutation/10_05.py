...
@register_task("robowits/10_05-v0")
class CollectScrewsMut5Env(CollectScrewsEnv):
    @property
    ...
    def _add_custom_entities(self) -> None:
        ...
        _e = self._scene.scene.add_entity(
            gs.morphs.Mesh(
                ...
                scale=1.0,
                pos=(0.40, -0.08, 0.76 + 0.0186),
                euler=(0, 0, 0),
                fixed=False,
                collision=True,
            ),
            material=gs.materials.Rigid(rho=200.0),
            surface=gs.surfaces.Smooth(color=(0.6, 0.4, 0.2), double_sided=True),
        )
