...
@register_task("robowits/17_06-v0")
class BallOntoTowerMut6Env(BallOntoTowerEnv):
    @property
    def placement_groups(self) -> PlacementGroups | None:
        """Define placement groups for random initialization."""
        return (("tower base", "large ring", "medium ring"), "small ring", "ball", "funnel", "mug")
