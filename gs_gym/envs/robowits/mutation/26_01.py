...
@register_task("robowits/26_01-v0")
class AlignChopsticksMut1Env(AlignChopsticksEnv):
    @property
    ...
    def _add_custom_entities(self) -> None:
        ...
        # Code Block: cosmetic bottle
        _e = self._scene.scene.add_entity(
            gs.morphs.Mesh(
                coacd_options=coacd_options,
                file=get_asset_path("blender_kit/02a55133-e41e-4770-9972-2f03a7cc3067/obj.glb", pattern_is_dir=False),
                scale=1.0,
                pos=(0.50, 0.44, 0.8218),
                euler=(0, 0, 0),
                fixed=False,
                collision=True,
            ),
        ...
        self._entities["cosmetic bottle"] = {"entity": _e}
        # Code Block: bowl
        _e = self._scene.scene.add_entity(
            gs.morphs.Mesh(
                coacd_options=coacd_options,
