...
@register_task("robowits/03_02-v0")
class GapRetrieveMut2Env(GapRetrieveEnv):
    @property
    def placement_groups(self) -> PlacementGroups | None:
        """Define placement groups for random initialization."""
        return (("lemon", "left boundary block", "right boundary block"), "target area", "coffee mug", "plastic ruler")
