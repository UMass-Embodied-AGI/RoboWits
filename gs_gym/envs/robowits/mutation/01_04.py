...
@register_task("robowits/01_04-v0")
class AlignBlocksMut4Env(AlignBlocksEnv):
    @property
    ...
    def _add_custom_entities(self) -> None:
        ...
        _e = self._scene.scene.add_entity(
            gs.morphs.Box(
                pos=(0.40, -0.05, 0.785), euler=(0, 0, 0), size=(0.05, 0.05, 0.05), fixed=True, collision=True
            ),
        ...
        _e = self._scene.scene.add_entity(
            gs.morphs.Box(
                pos=(0.55, 0.10, 0.785), euler=(0, 0, 0), size=(0.05, 0.05, 0.05), fixed=True, collision=True
            ),
            material=gs.materials.Rigid(rho=200.0),
            surface=gs.surfaces.Default(color=(0.6, 0.7, 0.9), roughness=0.5),
        )
        ...
        _e = self._scene.scene.add_entity(
            gs.morphs.Box(
                pos=(0.66, -0.02, 0.785), euler=(0, 0, 0), size=(0.05, 0.05, 0.05), fixed=False, collision=True
            ),
            material=gs.materials.Rigid(rho=200.0),
            surface=gs.surfaces.Default(color=(0.6, 0.7, 0.9), roughness=0.5),
        )
