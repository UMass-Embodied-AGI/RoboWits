...
@register_task("robowits/16_02-v0")
class StandBulbMut2Env(StandBulbEnv):
    @property
    ...
    def _add_custom_entities(self) -> None:
        ...
        # Code Block: gold_ring
        _e = self._scene.scene.add_entity(
            gs.morphs.Mesh(
                coacd_options=coacd_options,
                file=get_asset_path("blender_kit/02d04392-5d49-4e31-be80-20c0e3f64c4b/obj.glb", pattern_is_dir=False),
                scale=1.0,
                pos=(0.62, 0.12, 0.7652),
                euler=(0, 0, 0),
                fixed=False,
                collision=True,
            ),
        ...
        self._entities["gold_ring"] = {"entity": _e}
