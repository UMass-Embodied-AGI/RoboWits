...
@register_task("robowits/17_08-v0")
class BallOntoTowerMut8Env(BallOntoTowerEnv):
    @property
    def placement_groups(self) -> PlacementGroups | None:
        """Define placement groups for random initialization."""
        return (("tower base", "large ring", "medium ring"), "small ring", "ball", "bottle cap", "measuring spoon")
    ...
    def _add_custom_entities(self) -> None:
        ...
        # Code Block: measuring spoon
        _e = self._scene.scene.add_entity(
            gs.morphs.Mesh(
                coacd_options=coacd_options,
                file=get_asset_path("blender_kit/3658baf2-ca92-4852-90da-f1063777e29c/obj.glb", pattern_is_dir=False),
                scale=0.47,
                pos=(0.70, -0.3, 0.76 + 0.0469 * 0.47),
                euler=(0, 0, 30),
                fixed=False,
                collision=True,
            ),
        ...
        self._entities["measuring spoon"] = {"entity": _e}
