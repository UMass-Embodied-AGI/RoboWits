...
class DatasetConfig:
    ...
    val_frac: float = 0.0  # fraction of episodes held out for validation (0 = disabled)
...
class EvalConfig:
    ...
    # Whether to return episode data for online training
    return_episode_data: bool = False
    # Whether to enable data recording (saves observations, actions, info to disk)
    recording: bool = True
